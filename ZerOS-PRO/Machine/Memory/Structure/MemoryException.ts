/**
 * @module ZerOS.Machine.Memory.Exception
  ...
  export namespace Machine {
    export namespace Memory {
      ...
      export interface MemoryException {
         ...
         */
        ExceptionCategory: ExceptionCategoryRoot.Machine.Memory.ExceptionCategory;
      ...
      export function createMemoryException(params: {
        ...
        const category: ExceptionCategoryRoot.Machine.Memory.ExceptionCategory =
        ...
        const chain: object = params.ExceptionChain;
